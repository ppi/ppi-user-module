...
<div class="well clearfix container">
    ...
    <section id="user-edit-music" class="content clearfix well">
        ...
        <form action="<?=$view['router']->generate('User_Music_Edit_Submit');?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            <legend>Edit Music</legend>

            <input type="hidden" id="musicId" name="musicId" value="<?=$song->getId();?>">

            <div class="control-group">
                <label class="control-label" for="userTitle">Title <em>*</em></label>

                <div class="controls">
                    <input type="text" class="input-xlarge validate[required]" id="userTitle" name="userTitle" value="<?=$song->getTitle();?>">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="input-xlarge validate[required]" id="userMusic" name="userMusic" value="<?=$song->getLink();?>">
                    <span rel="userMusic" class="help-inline"></span>
                </div>
            </div>

            <div class="form-actions buttons-area">
                <input type="submit" class="btn btn-large" value="Edit Music">
            </div>

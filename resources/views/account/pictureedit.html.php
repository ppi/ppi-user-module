...
<div class="well clearfix container">
    ...
    <section id="user-edit-account" class="content clearfix well">
        ...
        <form action="<?=$view['router']->generate('User_Picture_Edit_Submit');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-actions buttons-area">
                <input type="submit" class="btn btn-large" value="Update Picture">
            </div>

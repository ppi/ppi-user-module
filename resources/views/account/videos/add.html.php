...
<div class="well clearfix container">
    ...
    <section id="user-edit-account" class="content clearfix well">
        ...
        <form action="<?=$view['router']->generate('User_Video_Create_Submit');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="input-xlarge validate[required]" id="userVideo" name="userVideo">
                    <span rel="userVideo" class="help-inline"></span>
                </div>
            </div>

            <div class="form-actions buttons-area">
                <input type="submit" class="btn btn-large" value="Create Video">
            </div>

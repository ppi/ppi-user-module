...
<div class="well clearfix container">
    ...
    <section id="user-edit-account" class="content clearfix well">
        ...
        <form action="<?=$view['router']->generate('User_Video_Edit_Submit');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="input-xlarge validate[required]" id="userTitle" name="userTitle" value="<?=$video->getTitle();?>">
                    <span rel="userTitle" class="help-inline"></span>
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="userVideo">YouTube URL <em>*</em></label>

                <div class="controls">
                    <input type="text" class="input-xlarge validate[required]" id="userVideo" name="userVideo" value="<?=$video->getLink();?>">
                    <span rel="userVideo" class="help-inline"></span>
                </div>
            </div>
